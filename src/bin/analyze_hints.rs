...
fn main() {
    ...
    writeln!(
        csv_file,
        "file,puzzle_id,starting_hints,hints_remaining,solutions_count,time_ms"
    )
    .unwrap();
    ...
    for file_path in dataset_files {
            ...
            .enumerate()
        {
            ...
            for i in (0..=hints.len()).rev() {
                ...
                println!(
                    "  Hints: {} -> Solutions: {} ({}ms)",
                    i, num_solutions, time_ms
                );
                writeln!(
                    csv_file,
                    "{},{},{},{},{},{}",
                    file_path, puzzle_id, starting_hints, i, num_solutions, time_ms
                )
                .unwrap();
